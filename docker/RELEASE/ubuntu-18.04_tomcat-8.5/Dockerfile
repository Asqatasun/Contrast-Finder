...
LABEL org.label-schema.schema-version = "1.0.0-rc.1"                                                     \
      org.label-schema.name           = "Contrast-Finder - WebApp (Ubuntu 18.04 - Tomcat 8.5, Java 11)"  \
...
#   docker build -t asqatasun/contrast-finder  --build-arg CONTRAST_FINDER_RELEASE=1.0.0-SNAPSHOT  .
#   docker build -t asqatasun/contrast-finder  --build-arg SRC_URL_PREFIX=https://github.com/Asqatasun/Contrast-Finder/releases/download/v1.0.0-SNAPSHOT/   .
#   docker build -t asqatasun/contrast-finder  --build-arg SRC_URL=https://github.com/Asqatasun/Contrast-Finder/releases/download/v1.0.0-SNAPSHOT/contrast-finder-webapp_1.0.0-SNAPSHOT.tar.gz   .
#
#   --- Launch a container
...
# build variables
ARG CONTRAST_FINDER_RELEASE="1.0.0-SNAPSHOT"
